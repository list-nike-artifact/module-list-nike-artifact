...
#undef curve_mg_fp2_cswap_points
#undef curve_mg_fp2_init
#undef curve_mg_fp2_init_from_A
#undef curve_mg_fp2_normalise
#undef curve_mg_fp2_normalise_A24
#undef curve_mg_fp2_normalise_and_A24
#undef curve_mg_fp2_select_point
#undef curve_mg_fp2_verify_A
#undef ec_j_inv
#undef point_eqw_fp2_normalise
#undef xpoint_eqw_fp2_add
#undef _xpoint_eqw_fp2_dbl
#undef xpoint_eqw_fp2_dbl
#undef _xpoint_eqw_fp2_dbl_A24
#undef _xpoint_eqw_fp2_dbladd
#undef _xpoint_eqw_fp2_dbl_E0
#undef xpoint_eqw_fp2_dbl_iter
#undef xpoint_eqw_fp2_dbl_iter_basis
#undef _xpoint_eqw_fp2_dblMUL
#undef xpoint_eqw_fp2_init
#undef xpoint_eqw_fp2_is_equal
#undef xpoint_eqw_fp2_is_two_torsion
#undef xpoint_eqw_fp2_is_zero
#undef _xpoint_eqw_fp2_mul
#undef xpoint_eqw_fp2_mul

#define curve_mg_fp2_cswap_points          SQISIGN_NAMESPACE(curve_mg_fp2_cswap_points)
#define curve_mg_fp2_init_from_A           SQISIGN_NAMESPACE(curve_mg_fp2_init_from_A)
#define curve_mg_fp2_init                  SQISIGN_NAMESPACE(curve_mg_fp2_init)
#define curve_mg_fp2_normalise_A24         SQISIGN_NAMESPACE(curve_mg_fp2_normalise_A24)
#define curve_mg_fp2_normalise_and_A24     SQISIGN_NAMESPACE(curve_mg_fp2_normalise_and_A24)
#define curve_mg_fp2_normalise             SQISIGN_NAMESPACE(curve_mg_fp2_normalise)
#define curve_mg_fp2_select_point          SQISIGN_NAMESPACE(curve_mg_fp2_select_point)
#define curve_mg_fp2_verify_A              SQISIGN_NAMESPACE(curve_mg_fp2_verify_A)
#define point_eqw_fp2_normalise            SQISIGN_NAMESPACE(point_eqw_fp2_normalise)
#define xpoint_eqw_fp2_add                 SQISIGN_NAMESPACE(xpoint_eqw_fp2_add)
#define _xpoint_eqw_fp2_dbl_A24            SQISIGN_NAMESPACE(_xpoint_eqw_fp2_dbl_A24)
#define _xpoint_eqw_fp2_dbladd             SQISIGN_NAMESPACE(_xpoint_eqw_fp2_dbladd)
#define _xpoint_eqw_fp2_dbl_E0             SQISIGN_NAMESPACE(_xpoint_eqw_fp2_dbl_E0)
#define xpoint_eqw_fp2_dbl_iter_basis      SQISIGN_NAMESPACE(xpoint_eqw_fp2_dbl_iter_basis)
#define xpoint_eqw_fp2_dbl_iter            SQISIGN_NAMESPACE(xpoint_eqw_fp2_dbl_iter)
#define _xpoint_eqw_fp2_dblMUL             SQISIGN_NAMESPACE(_xpoint_eqw_fp2_dblMUL)
#define _xpoint_eqw_fp2_dbl                SQISIGN_NAMESPACE(_xpoint_eqw_fp2_dbl)
#define xpoint_eqw_fp2_dbl                 SQISIGN_NAMESPACE(xpoint_eqw_fp2_dbl)
#define xpoint_eqw_fp2_init                SQISIGN_NAMESPACE(xpoint_eqw_fp2_init)
#define xpoint_eqw_fp2_is_equal            SQISIGN_NAMESPACE(xpoint_eqw_fp2_is_equal)
#define xpoint_eqw_fp2_is_two_torsion      SQISIGN_NAMESPACE(xpoint_eqw_fp2_is_two_torsion)
#define xpoint_eqw_fp2_is_zero             SQISIGN_NAMESPACE(xpoint_eqw_fp2_is_zero)
#define _xpoint_eqw_fp2_mul                SQISIGN_NAMESPACE(_xpoint_eqw_fp2_mul)
#define xpoint_eqw_fp2_mul                 SQISIGN_NAMESPACE(xpoint_eqw_fp2_mul)

// Namespacing symbols exported from ec_jac.c:
#undef jac_from_ws
#undef jac_to_ws
#undef point_jac_fp2_add
#undef point_jac_fp2_copy
#undef point_jac_fp2_dbl
#undef point_jac_fp2_dblw
#undef point_jac_fp2_init
#undef point_jac_fp2_is_equal
#undef point_jac_fp2_neg
#undef point_jac_fp2_select
#undef point_jac_fp2_to_ec
#undef point_jac_fp2_to_xz_add_components

#define jac_from_ws                        SQISIGN_NAMESPACE(jac_from_ws)
#define jac_to_ws                          SQISIGN_NAMESPACE(jac_to_ws)
#define point_jac_fp2_add                  SQISIGN_NAMESPACE(point_jac_fp2_add)
#define point_jac_fp2_copy                 SQISIGN_NAMESPACE(point_jac_fp2_copy)
#define point_jac_fp2_dbl                  SQISIGN_NAMESPACE(point_jac_fp2_dbl)
#define point_jac_fp2_dblw                 SQISIGN_NAMESPACE(point_jac_fp2_dblw)
#define point_jac_fp2_init                 SQISIGN_NAMESPACE(point_jac_fp2_init)
#define point_jac_fp2_is_equal             SQISIGN_NAMESPACE(point_jac_fp2_is_equal)
#define point_jac_fp2_neg                  SQISIGN_NAMESPACE(point_jac_fp2_neg)
#define point_jac_fp2_select               SQISIGN_NAMESPACE(point_jac_fp2_select)
#define point_jac_fp2_to_ec                SQISIGN_NAMESPACE(point_jac_fp2_to_ec)
#define point_jac_fp2_to_xz_add_components SQISIGN_NAMESPACE(point_jac_fp2_to_xz_add_components)
...
#undef couple_point_jac_fp2_to_ec
...
#define couple_point_jac_fp2_to_ec                                SQISIGN_NAMESPACE(couple_point_jac_fp2_to_ec)
