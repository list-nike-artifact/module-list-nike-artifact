...
static uint32_t
projective_is_on_curve(const xpoint_eqw_fp2_t *P, const curve_mg_fp2_t *curve)
{
...
void
ec_random_normalized_test(xpoint_eqw_fp2_t *P, const curve_mg_fp2_t *curve)
{
    fp2_set_one(&P->z);
    while (1) {
        fp2_random_test(&P->x);
...
void
ec_random_test(xpoint_eqw_fp2_t *P, const curve_mg_fp2_t *curve)
{
...
void
projective_difference_point(xpoint_eqw_fp2_t *PQ, const xpoint_eqw_fp2_t *P, const xpoint_eqw_fp2_t *Q, const curve_mg_fp2_t *curve)
{
