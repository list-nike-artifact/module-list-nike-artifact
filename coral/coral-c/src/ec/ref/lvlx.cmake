set(SOURCE_FILES_EC_${SVARIANT_UPPER}_REF
    ...
    ${LVLX_DIR}/ec_fp.c
    ${LVLX_DIR}/ec_jac.c
    ${LVLX_DIR}/ec_jac_fp.c
    ${LVLX_DIR}/isog_sw.c
    ${LVLX_DIR}/isog_sw_fp.c
    ${LVLX_DIR}/basis.c
)

add_library(${LIB_EC_${SVARIANT_UPPER}} STATIC ${SOURCE_FILES_EC_${SVARIANT_UPPER}_REF})
target_include_directories(${LIB_EC_${SVARIANT_UPPER}} PRIVATE ${INC_COMMON} ${INC_PRECOMP_${SVARIANT_UPPER}} ${INC_PUBLIC} ${INC_QUATERNION} ${INC_MP} ${INC_GF} ${INC_GF_${SVARIANT_UPPER}} ${INC_EC})
