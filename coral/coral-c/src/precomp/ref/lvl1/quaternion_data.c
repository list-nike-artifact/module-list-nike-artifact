...
const uint32_t QUAT_good_primes_list[12] = {5, 13, 17, 29, 37, 41, 53, 61, 73, 89, 97, 101};
const uint32_t QUAT_bad_primes_list[25] = {3, 7, 11, 19, 23, 31, 43, 47, 59, 67, 71, 79, 83, 103, 107, 127, 131, 139, 151, 163, 167, 179, 191, 199, 211};
