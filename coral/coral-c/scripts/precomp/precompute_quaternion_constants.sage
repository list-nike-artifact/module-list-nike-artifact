...
from parameters import p, primes_per_order, good_primes, bad_primes
negl = 2**-64
...
defs['QUAT_primality_num_iter'] = 2 #ceil(-log(negl, 4))
defs['QUAT_repres_bound_input'] = add_shift
defs['QUAT_good_primes_length'] = good_primes
defs['QUAT_bad_primes_length'] = bad_primes
...
defs['QUAT_qlapoti_gen_bound_bits'] = 17
defs['QUAT_qlapoti_used_power_of_two'] = tors2val-2
defs['QUAT_qlapoti_iteration_bound'] = 20000
