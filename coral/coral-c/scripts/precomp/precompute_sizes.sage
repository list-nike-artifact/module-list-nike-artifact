...
if(p.bit_length()<128):
    SECURITY_BITS = 64
CORAL_INDIVISIBLE_EXP = logp+logp.bit_length()+SECURITY_BITS
CORAL_NO_INDIVISIBLE_EXP = logp+logp.bit_length()+2*SECURITY_BITS
CORAL_CSIDH_EXP = 2*tors2val-1
...
defs['CORAL_CSIDH_EXP'] = CORAL_CSIDH_EXP
defs['CORAL_INDIVISIBLE_EXP'] = CORAL_INDIVISIBLE_EXP
defs['CORAL_NO_INDIVISIBLE_EXP'] = CORAL_NO_INDIVISIBLE_EXP
...
#with open(f'../../../nistapi/{lvl}/api.h', 'w') as f:
#    print(api, file=f)
